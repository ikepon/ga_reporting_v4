describe GaReportingV4::Management::WebProperty do
  ...
  let!(:web_property) { GaReportingV4::Management::WebProperty.new(attributes, user) }
  ...
  context 'Class methods' do
    ...
    context '#build_from_summary' do
      ...
      let!(:web_property_from_summary) { GaReportingV4::Management::WebProperty.build_from_summary(account_summary, user) }
    ...
    context '#for_account' do
      ...
      let!(:web_property_from_account) { GaReportingV4::Management::WebProperty.for_account(account) }
