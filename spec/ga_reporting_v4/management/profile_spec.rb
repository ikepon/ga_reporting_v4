describe GaReportingV4::Management::Profile do
  ...
  let!(:profile) { GaReportingV4::Management::Profile.new(attributes, user) }
  ...
  context 'Class methods' do
    ...
    context '#build_from_summary' do
      ...
      let!(:profile_from_summary) { GaReportingV4::Management::Profile.build_from_summary(summary_attributes, user) }
    ...
    context '#for_account' do
      ...
      let!(:profiles_from_account) { GaReportingV4::Management::Profile.for_account(account) }
    ...
    context '#for_web_property' do
      ...
      let!(:profiles_from_web_property) { GaReportingV4::Management::Profile.for_web_property(web_property) }
