describe GaReportingV4::Management::Goal do
  ...
  let!(:goal) { GaReportingV4::Management::Goal.new(attributes, user) }
  ...
  context 'Class methods' do
    ...
    context '#for_account' do
      ...
      let!(:goals_from_account) { GaReportingV4::Management::Goal.for_account(account) }
    ...
    context '#for_web_property' do
      ...
      let!(:goals_from_web_property) { GaReportingV4::Management::Goal.for_web_property(web_property) }
    ...
    context '#for_profile' do
      ...
      let!(:goals_from_profile) { GaReportingV4::Management::Goal.for_profile(profile) }
