describe Hisui::Management::AccountSummary do
  ...
  let!(:account_summary) { Hisui::Management::AccountSummary.new(attributes, user) }

  context 'Class methods' do
    context '#new' do
      it 'creates a new account summary instance' do
        expect(account_summary.account.class).to eq(Hisui::Management::Account)
